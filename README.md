...
Это мой первый (the first) проект на C++, в котором полноценно реализованы принципы парадигмы ООП данного языка.
...
Данная структура данных должна оптимально хранить информацию о поле (очень!).
...
> P.S. При сдаче работы моему лаборанту было упомянута идея хранения данных о поле в файле, для того чтобы изменить способ хранения поля в оперативной памяти на жесткий диск.
